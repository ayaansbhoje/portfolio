...
export const TV_CHANNELS: Channel[] = [
  { id: 'ch1', brand: 'Aurora Studios', short: 'AUR', logo: '🎬', video: '/assets/channel_1.mp4', accent: '#00F5FF', tagline: 'Brand Film · 2024' },
  { id: 'ch2', brand: 'Neon Athletics', short: 'NEO', logo: '⚡', video: '/assets/channel_2.mp4', accent: '#FF2D78', tagline: 'Product Launch Reel' },
