  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-30 flex items-center gap-5 font-mono text-xs pointer-events-none"
        ...
        <span className="flex items-center gap-1.5"><span>💻</span><span style={{ color: 'rgba(0,245,255,0.8)' }}>Laptop</span></span>
        <span className="flex items-center gap-1.5"><span>📱</span><span style={{ color: 'rgba(255,45,120,0.8)' }}>Phone</span></span>
        <span className="flex items-center gap-1.5"><span>📖</span><span style={{ color: 'rgba(255,179,71,0.8)' }}>Journal</span></span>
        <span className="flex items-center gap-1.5"><span>🎶</span><span style={{ color: 'rgba(176,96,255,0.8)' }}>Vinyl</span></span>
        <span className="flex items-center gap-1.5"><span>📺</span><span style={{ color: 'rgba(62,169,255,0.85)' }}>TV</span></span>
      </div>
